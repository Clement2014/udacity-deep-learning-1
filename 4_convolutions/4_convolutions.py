...
with graph.as_default():
  ...
  # // equals math.floor
  W_fc1 = weight_variable([image_size // 4 * image_size // 4 * depth, num_hidden])
  ...
  loss = cross_entropy + 0.001 * (tf.nn.l2_loss(W_fc1) + tf.nn.l2_loss(b_fc1) + tf.nn.l2_loss(W_fc2) + tf.nn.l2_loss(b_fc2))
