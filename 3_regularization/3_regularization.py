...
with tf.Session(graph=graph) as session:
  ...
  for step in range(num_steps):
    ...
    feed_dict = {tf_train_dataset : batch_data, tf_train_labels : batch_labels, tf_beta : 0.001}
  ...
  print("L2 regularization Test accuracy: %.1f%%" % accuracy(test_prediction.eval(), test_labels))
